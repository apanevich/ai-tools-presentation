...
\begin{frame}{Карта экосистемы}
  \begin{itemize}
    \item \textbf{Чат-интерфейсы} — ChatGPT, Claude, Gemini, DeepSeek\ldots
    \item \textbf{API} — OpenAI, Anthropic, Google, OpenRouter\ldots
    \item \textbf{IDE / редакторы} — Cursor, GitHub Copilot, Continue
    \item \textbf{Агенты} — AutoGPT, Cursor Agent, Claude Code
    \item \textbf{Локальные модели} — Ollama, LM Studio
    \item \textbf{Российские платформы} — GigaChat, YandexGPT, Yandex AI Studio, Koda
  \end{itemize}
\end{frame}
...
\begin{frame}{Российские платформы — краткий обзор}
  \begin{itemize}
    ...
    \item \textbf{Yandex AI studio}
    \item \textbf{SourceCraft}
    \item \textbf{Другие}
  \end{itemize}
  \vspace{0.5em}
\end{frame}
...
\end{document}\usepackage{graphicx}